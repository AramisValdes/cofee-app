...
CREATE_BEANS_TABLE = "CREATE TABLE IF NOT EXISTS beans (id INTEGER PRIMARY KEY, name TEXT method TEXT, method TEXT, rating INTEGER);"
...
# Connects to database (in this case it checks if data.db exists)
def connect():
    return sqlite3.connect("data.db")


# creates sql table with the SQL command stored in CREATE_BEANS_TABLE
